...
export const usePageList = (documentInstance: false | pdfjs.PDFDocumentProxy | undefined) => {
    const windowWidth = useWindowWidth();
    const windowHeight = useWindowHeight();
    const [documentRef] = useState<false | pdfjs.PDFDocumentProxy | undefined>(documentInstance);
