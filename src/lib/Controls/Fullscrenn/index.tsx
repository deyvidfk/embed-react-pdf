import React, { ButtonHTMLAttributes, ComponentType, FC, ReactElement, ReactNode } from "react"
...
const FullScreenControl: FC<TFullScreenControl> = ({ children, containerId, as: asProp, ...restProps }) => {
